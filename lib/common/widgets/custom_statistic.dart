...
class CustomStatistic extends CustomState {
  ...
  const CustomStatistic({super.key, required this.name, required this.size, required this.progress, required this.maxProgress, required this.color});
  ...
  Widget execute(BuildContext context) {
    ...
    return Container(
      height: 140,
      decoration: BoxDecoration(color: color.withOpacity(0.3), borderRadius: BorderRadius.circular(CustomSizes.SPACE_BETWEEN_ITEMS)),
